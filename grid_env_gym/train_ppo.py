...
def train(total_timesteps=100000, save_name="ppo_grid"):
    ...
    print("Starting PPO training with TensorBoard logging...")
...
if __name__ == "__main__":
    train(total_timesteps=500000, save_name="ppo_grid_large")
